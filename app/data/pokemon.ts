...
export const POKEMON: Pokemon[] = [
  {id:25,name:"Pikachu",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"A",type:"electric",tag:"Att. Speciale",winRate:48.36,winRateChange:0.29,moves:["Tuonoshock","Energisfera","Fulmine","Locomovolt","Tuono","Energisfera"],uniteMove:"Bolle di Tuono"},
  {id:815,name:"Cinderace",role:"Attaccante",style:"Distanza",damage:"Fisico",difficulty:"Principiante",tier:"S",type:"fire",tag:"Att. Fisico",winRate:48.36,winRateChange:-0.3,moves:["Braciere","Sottocarico","Palla Infuocata","Calciardente","Nitrocarica","Fintoattacco"],uniteMove:"Rovesciata Fiammante"},
  {id:3,name:"Venusaur",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"grass",tag:"Att. Speciale",winRate:48.58,winRateChange:0.46,moves:["Semebomba","Fogliamagica","Fangobomba","Gigassorbimento","Solarraggio","Petalodanza"],uniteMove:"Furia Verde"},
  {id:10103,name:"Ninetales di Alola",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"ice",tag:"Att. Speciale",winRate:47.52,winRateChange:0.24,moves:["Polvereneve","Ventogelo","Magibrillio","Valanga","Velaurora","Bora"],uniteMove:"Nube di Neve"},
  {id:282,name:"Gardevoir",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"B",type:"psychic",tag:"Att. Speciale",winRate:49.72,winRateChange:-0.08,moves:["Confusione","Teletrasporto","Psicoshock","Divinazione","Psichico","Forzalunare"],uniteMove:"Vuoto Fatato"},
  {id:658,name:"Greninja",role:"Attaccante",style:"Distanza",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"water",tag:"Att. Fisico",winRate:48.92,winRateChange:-0.22,moves:["Bolla","Sostituto","Doppioteam","Muro di Fumo","Acquashuriken","Surf"],uniteMove:"Acquashuriken Gigante"},
  {id:845,name:"Cramorant",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Esperto",tier:"C",type:"flying",tag:"Att. Speciale",winRate:45.70,winRateChange:-1.24,moves:["Mulinello","Danzadipiume","Tifone","Eaerassalto","Surf","Sub"],uniteMove:"Raffica di Inghiottitutto"},
  {id:700,name:"Sylveon",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"fairy",tag:"Att. Speciale",winRate:47.18,winRateChange:0.00,moves:["Cometapugno","Occhioni Teneri","Magifuoco","Granvoce","Assorbabacio","Calmamente"],uniteMove:"Danza Fatata"},
  {id:724,name:"Decidueye",role:"Attaccante",style:"Distanza",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"grass",tag:"Att. Fisico",winRate:51.25,winRateChange:-0.13,moves:["Fogliame","Sbigottimento","Fogliamagica","Cucitura d'Ombra","Fogliatempesta","Furtivombra"],uniteMove:"Raffica di Frecce"},
  {id:471,name:"Glaceon",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"ice",tag:"Att. Speciale",winRate:49.11,winRateChange:0.67,moves:["Cometapugno","Ventogelo","Gelolancia","Ventogelo","Gelo-scheggia","Liofilizzazione"],uniteMove:"Palcoscenico Glaciale"},
  {id:196,name:"Espeon",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"B",type:"psychic",tag:"Att. Speciale",winRate:49.49,winRateChange:0.24,moves:["Cometapugno","Rugito","Psicoshock","Veicolaforza","Psicoraggio","Divinazione"],uniteMove:"Psicosole"},
  {id:655,name:"Delphox",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"B",type:"fire",tag:"Att. Speciale",winRate:49.91,winRateChange:-0.4,moves:["Braciere","Fuocofatuo","Fuocobomba","Magifuoco","Turbofuoco","Nitrocarica"],uniteMove:"Fuochi d'Artificio Fatati"},
  {id:884,name:"Duraludon",role:"Attaccante",style:"Distanza",damage:"Fisico",difficulty:"Intermedio",tier:"C",type:"steel",tag:"Att. Fisico",winRate:51.31,winRateChange:1.57,moves:["Alidifesa","Spaccaroccia","Cannone Flash","Dragopulsar","Levitoroccia","Codadrago"],uniteMove:"Rovina Rotante"},
  {id:887,name:"Dragapult",role:"Attaccante",style:"Distanza",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"dragon",tag:"Att. Fisico",winRate:48.75,winRateChange:0.71,moves:["Sbigottimento","Attacco Rapido","Dragospiro","Palla Ombra","Dragodanza","Spettrotuffo"],uniteMove:"Raffica di Dreepy"},
  {id:151,name:"Mew",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"A",type:"psychic",tag:"Att. Speciale",winRate:48.38,winRateChange:-1.34,moves:["Botta","Agilità","Energisfera","Solarraggio","Surf","Aiuto","Schermoluce"],uniteMove:"Miraggio Mistico"},
  {id:609,name:"Chandelure",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"A",type:"ghost",tag:"Att. Speciale",winRate:49.12,winRateChange:1.01,moves:["Braciere","Ombronotturna","Lanciafiamme","Vampata","Poltergeist","Prigione"],uniteMove:"Fuoco di Sbarramento"},
  {id:818,name:"Inteleon",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"B",type:"water",tag:"Att. Speciale",winRate:50.39,winRateChange:0.07,moves:["Pistolacqua","Occhioni Teneri","Pungiglione","Acrobazia","Idroliquidazione","Tiromirato"],uniteMove:"Spia Azzurra"},
  {id:1008,name:"Miraidon",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"S",type:"electric",tag:"Att. Speciale",winRate:49.85,winRateChange:-0.08,moves:["Tuonoshock","Raggioscossa","Saetta Fulminante","Tuono","Carica Parabolica","Manovra Derapata"],uniteMove:"Futuro Splendente"},
  {id:663,name:"Talonflame",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"A",type:"fire",tag:"Att. Fisico",winRate:49.93,winRateChange:0.96,moves:["Beccata","Acrobazia","Nitrocarica","Aereassalto","Volo","Baldavace"],uniteMove:"Fiammivoro"},
  {id:359,name:"Absol",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"B",type:"dark",tag:"Att. Fisico",winRate:45.92,winRateChange:-1.18,moves:["Fintoattacco","Lacerazione","Nottesferza","Inseguimento","Psicotaglio","Sbigoattacco"],uniteMove:"Squarcio Notturno"},
  {id:94,name:"Gengar",role:"Velocista",style:"Mischia",damage:"Sp.",difficulty:"Esperto",tier:"A",type:"ghost",tag:"Att. Speciale",winRate:51.02,winRateChange:-0.63,moves:["Fuocofatuo","Leccata","Palla Ombra","Fangobomba","Mangiasogni","Sciagura"],uniteMove:"Agguato Oscuro"},
  {id:807,name:"Zeraora",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"A",type:"electric",tag:"Att. Fisico",winRate:47.70,winRateChange:0.39,moves:["Agilità","Lacerazione","Invertivolt","Scintilla","Scarica","Sprizzalampo"],uniteMove:"Tempesta Plasma"},
  {id:571,name:"Zoroark",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"dark",tag:"Att. Fisico",winRate:45.42,winRateChange:-0.55,moves:["Lacerazione","Sfuriate","Nottesferza","Fintoattacco","Ombrartigli","Taglio"],uniteMove:"Urtoscuro"},
  {id:85,name:"Dodrio",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"B",type:"normal",tag:"Att. Fisico",winRate:51.01,winRateChange:0.09,moves:["Beccata","Attacco Rapido","Triattacco","Perforbecco","Agilità","Calciopesante"],uniteMove:"Triplo Calpestamento"},
  {id:470,name:"Leafeon",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"grass",tag:"Att. Fisico",winRate:49.14,winRateChange:0.6,moves:["Fogliamagica","Cometapugno","Lamsolare","Fogliama","Aereassalto","Furia d'Incrocio"],uniteMove:"Danza di Smeraldo"},
  {id:911,name:"Meowscarada",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"S",type:"grass",tag:"Att. Fisico",winRate:48.14,winRateChange:-0.19,moves:["Fogliame","Unghiaguzze","Prestigiatore","Nottesferza","Doppioteam","Apripista"],uniteMove:"Fioritura Esplosiva"},
  {id:6,name:"Charizard",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"A",type:"fire",tag:"Att. Fisico",winRate:49.43,winRateChange:-0.05,moves:["Fiammata","Turbofuoco","Lanciafiamme","Fuocopugno","Fuocobomba","Fuococarica"],uniteMove:"Schiacciata Sismica"},
  {id:448,name:"Lucario",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"fighting",tag:"Att. Fisico",winRate:48.12,winRateChange:-0.55,moves:["Attacco Rapido","Meteorpugno","Extrarapido","Crescipugno","Ossoraffiche","Zuffa"],uniteMove:"Ondasfera Letale"},
  {id:68,name:"Machamp",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"fighting",tag:"Att. Fisico",winRate:50.01,winRateChange:-0.32,moves:["Colpokarate","Granfisico","Dinamipugno","Sottomissione","Zuffa","Incrocolpo"],uniteMove:"Schiacciata di Machamp"},
  {id:445,name:"Garchomp",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"dragon",tag:"Att. Fisico",winRate:49.87,winRateChange:-0.46,moves:["Turbosabbia","Pestone","Dragofuria","Fossa","Dragartigli","Terremoto"],uniteMove:"Furia Livida"},
  {id:149,name:"Dragonite",role:"Versatile",style:"Distanza",damage:"Fisico",difficulty:"Principiante",tier:"A",type:"dragon",tag:"Att. Fisico",winRate:50.41,winRateChange:1.07,moves:["Tornado","Dragodanza","Dragospiro","Extrarapido","Oltraggio","Iper Raggio"],uniteMove:"Impatto Draconico"},
  {id:763,name:"Tsareena",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"grass",tag:"Att. Fisico",winRate:51.66,winRateChange:1.23,moves:["Fogliamagica","Rapigiro","Triplo Axel","Pestone","Tropocalcio","Erboscivolata"],uniteMove:"Regalità Aerea"},
  {id:681,name:"Aegislash",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"B",type:"steel",tag:"Att. Fisico",winRate:45.78,winRateChange:-1.94,moves:["Furtivombra","Ferroscudo","Spadasanta","Ombrartigli","Ferroriduttore","Scudo Reale"],uniteMove:"Fendente Finale"},
  {id:212,name:"Scizor",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"bug",tag:"Att. Fisico",winRate:49.96,winRateChange:-0.16,moves:["Attacco Rapido","Tagliofuria","Pugnoscarica","Danzaspada","Doppioffensiva","Ferroriduttore"],uniteMove:"Illusione Rossa"},
  {id:248,name:"Tyranitar",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"rock",tag:"Att. Fisico",winRate:50.74,winRateChange:-1.64,moves:["Lucidatura","Morso","Neropulsar","Pietrataglio","Forzantica","Sabbiatomba"],uniteMove:"Furia Tirannica"},
  {id:794,name:"Buzzwole",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"bug",tag:"Att. Fisico",winRate:46.86,winRateChange:-0.24,moves:["Pungiglione","Megapugno","Assalto","Abbattimento","Crescipugno","Sanguisuga"],uniteMove:"Superlancio Muscolare"},
  {id:184,name:"Azumarill",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"C",type:"water",tag:"Att. Fisico",winRate:46.35,winRateChange:-0.08,moves:["Azione","Bolla","Mulinello","Idrocoda","Carineria","Idropulsar"],uniteMove:"Panciata Tamburo"},
  {id:376,name:"Metagross",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"S",type:"steel",tag:"Att. Fisico",winRate:49.20,winRateChange:-0.09,moves:["Ferroscudo","Azione","Meteorpugno","Giroballa","Zuccata Zen","Magnetascesa"],uniteMove:"Analisi ed Impatto"},
  {id:892,name:"Urshifu",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"fighting",tag:"Att. Fisico",winRate:50.34,winRateChange:0.78,moves:["Spaccaroccia","Pugnotenebre","Golaforata","Spaccaroccia","Idroraffica","Idroliquidazione"],uniteMove:"Pugno d'Ebano / Raffica di Pugni"},
  {id:143,name:"Snorlax",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"S",type:"normal",tag:"Att. Fisico",winRate:49.88,winRateChange:0.53,moves:["Azione","Riposo","Pesobomba","Flagello","Blocco","Sbadiglio"],uniteMove:"Sonnellino Reale"},
  {id:80,name:"Slowbro",role:"Difensore",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"water",tag:"Att. Speciale",winRate:48.42,winRateChange:0.15,moves:["Pistolacqua","Pigrizia","Idrovampata","Surf","Amnesia","Telecinesi"],uniteMove:"Sguardo Immobile"},
  {id:558,name:"Crustle",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"B",type:"bug",tag:"Att. Fisico",winRate:49.54,winRateChange:0.58,moves:["Frana","Tagliofuria","Gettaguscio","Tombarocciata","Levitoroccia","Furia d'Incrocio"],uniteMove:"Frantumaroccia"},
  {id:820,name:"Greedent",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"normal",tag:"Att. Fisico",winRate:50.37,winRateChange:-1.34,moves:["Azione","Ricciolscudo","Semitraglia","Rutto","Guancegonfie","Supplica"],uniteMove:"Panciata di Bacche"},
  {id:709,name:"Trevenant",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"ghost",tag:"Att. Fisico",winRate:49.69,winRateChange:0.39,moves:["Fuocofatuo","Ramopuntura","Mazzuolegno","Maledizione","Mazzuolcorno","Malcomune"],uniteMove:"Foresta Spettrale"},
  {id:473,name:"Mamoswine",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"ice",tag:"Att. Fisico",winRate:48.88,winRateChange:0.51,moves:["Gelo-scheggia","Azione","Scagliagelo","Gelodenti","Forza Equina","Terremoto"],uniteMove:"Pestone del Mammut"},
  {id:9,name:"Blastoise",role:"Difensore",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"water",tag:"Att. Speciale",winRate:51.93,winRateChange:-0.19,moves:["Pistolacqua","Capocciata","Idropompa","Zampillo","Surf","Rapigiro"],uniteMove:"Tifone Idrico"},
  {id:197,name:"Umbreon",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"S",type:"dark",tag:"Att. Fisico",winRate:48.63,winRateChange:0.26,moves:["Cometapugno","Falsalacrima","Malosguardo","Ripicca","Desiderio","Urlorabbia"],uniteMove:"Danza Lunare"},
  {id:131,name:"Lapras",role:"Difensore",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"water",tag:"Att. Speciale",winRate:48.39,winRateChange:0.09,moves:["Pistolacqua","Mulinello","Gelo-raggio","Liofilizzazione","Idropulsar","Bolla-raggio"],uniteMove:"Lapras Express"},
  {id:830,name:"Eldegoss",role:"Supporto",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"B",type:"grass",tag:"Att. Speciale",winRate:49.41,winRateChange:0.14,moves:["Fogliame","Sintesi","Sferapollina","Fogliatempesta","Cotonscudo","Cotonspora"],uniteMove:"Atterraggio Morbido"},
  {id:122,name:"Mr. Mime",role:"Supporto",style:"Mischia",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"psychic",tag:"Att. Speciale",winRate:51.29,winRateChange:-0.53,moves:["Bruciapelo","Schermoluce","Confusione","Psichico","Barriera","Vigorscambio"],uniteMove:"È l'ora dello show!"},
  {id:40,name:"Wigglytuff",role:"Supporto",style:"Mischia",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"fairy",tag:"Att. Speciale",winRate:51.12,winRateChange:1.37,moves:["Botta","Ricciolscudo","Doubleschaffo","Magibrillio","Canto","Rotolamento"],uniteMove:"Recital Stellare"},
  {id:242,name:"Blissey",role:"Supporto",style:"Mischia",damage:"Sp.",difficulty:"Principiante",tier:"S",type:"normal",tag:"Att. Speciale",winRate:47.62,winRateChange:-0.38,moves:["Botta","Ondasana","Uovobomba","Altruismo","Covauova","Salvaguardia"],uniteMove:"Blissey ai Ripari"},
  {id:720,name:"Hoopa",role:"Supporto",style:"Distanza",damage:"Sp.",difficulty:"Esperto",tier:"S",type:"psychic",tag:"Att. Speciale",winRate:50.30,winRateChange:0.63,moves:["Sbigottimento","Confusione","Foro Dimensional","Prestigio","Spettrotuffo","Palla Ombra"],uniteMove:"Cerchi Liberati"},
  {id:36,name:"Clefable",role:"Supporto",style:"Mischia",damage:"Sp.",difficulty:"Principiante",tier:"A",type:"fairy",tag:"Att. Speciale",winRate:48.01,winRateChange:1.42,moves:["Botta","Ondasana","Fidofonte","Assorbabacio","Gravità","Sonoqui"],uniteMove:"Desiderio Fatato"},
  {id:764,name:"Comfey",role:"Supporto",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"S",type:"fairy",tag:"Att. Speciale",winRate:47.82,winRateChange:1.94,moves:["Sintesi","Fogliamagica","Cura Floreale","Laccioerboso","Dolcebacio","Fogliamagica"],uniteMove:"Carezza Floreale"},
  {id:302,name:"Sableye",role:"Supporto",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"B",type:"dark",tag:"Att. Fisico",winRate:45.21,winRateChange:-0.57,moves:["Furto","Sbigottimento","Privazione","Furtivombra","Stordiraggio","Fintoattacco"],uniteMove:"Sguardo Caotico"},
  // Attaccanti aggiuntivi
  {id:491,name:"Darkrai",role:"Velocista",style:"Distanza",damage:"Sp.",difficulty:"Esperto",tier:"S",type:"dark",tag:"Att. Speciale",winRate:50.69,winRateChange:0.87,moves:["Neropulsar","Palla Ombra","Vuototetro","Incubo","Congiura","Doppioteam"],uniteMove:"Incubo Eterno"},
  {id:381,name:"Latios",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"dragon",tag:"Att. Speciale",winRate:49.10,winRateChange:-0.18,moves:["Abbagliante","Dragospiro","Zuccata Zen","Ripresa","Dragopulsar","Psicoshock"],uniteMove:"Ali di Latios"},
  {id:936,name:"Armarouge",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"fire",tag:"Att. Speciale",winRate:50.61,winRateChange:1.18,moves:["Braciere","Fuocofatuo","Corazzaluna","Turbofuoco","Nitrocarica","Psicoshock"],uniteMove:"Esplosione Psico-X"},
  {id:10035,name:"Mega Charizard Y",role:"Versatile",style:"Distanza",damage:"Sp.",difficulty:"Esperto",tier:"S",type:"fire",tag:"Att. Speciale",winRate:56.39,winRateChange:0.73,moves:["Fiammata","Turbofuoco","Lanciafiamme","Fuocopugno","Fuocobomba","Fuococarica"],uniteMove:"Megaevoluzione"},
  {id:10044,name:"Mega Mewtwo Y",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Esperto",tier:"S",type:"psychic",tag:"Att. Speciale",winRate:53.12,winRateChange:0.84,moves:["Tuonoshock","Raggioscossa","Saetta Fulminante","Tuono","Carica Parabolica","Manovra Derapata"],uniteMove:"Futuro Splendente"},
  // Velocisti aggiuntivi
  {id:937,name:"Ceruledge",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"A",type:"fire",tag:"Att. Fisico",winRate:51.69,winRateChange:0.29,moves:["Braciere","Furtivombra","Lama del Rimorso","Psicotaglio","Spettrotuffo","Nitrocarica"],uniteMove:"Squarcio Spettrale"},
  {id:778,name:"Mimikyu",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"ghost",tag:"Att. Fisico",winRate:51.36,winRateChange:0.06,moves:["Sbigottimento","Graffio","Carineria","Ombrartigli","Furtivombra","Dolcetto o Scherzetto"],uniteMove:"Giochiamo Insieme?"},
  {id:10100,name:"Raichu",role:"Versatile",style:"Mischia",damage:"Sp.",difficulty:"Intermedio",tier:"B",type:"electric",tag:"Att. Speciale",winRate:47.63,winRateChange:-1.02,moves:["Tuonoshock","Scintilla","Fulmine","Locomovolt","Tuono","Codacciaio"],uniteMove:"Surfsplash di Alola"},
  {id:123,name:"Scyther",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"B",type:"bug",tag:"Att. Fisico"},
  {id:52,name:"Meowth",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"normal",tag:"Att. Fisico",winRate:50.28,winRateChange:-1.7,moves:["Bruciapelo","Sfuriate","Giorno Paga","Morso","Lacerazione","Carineria"],uniteMove:"Agguato del Team Rocket"},
  // Versatili aggiuntivi
  {id:257,name:"Blaziken",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"A",type:"fire",tag:"Att. Fisico",winRate:50.00,winRateChange:-0.37,moves:["Aereassalto","Braciere","Fuocopugno","Vampata","Focalcolpo","Calciardente"],uniteMove:"Vortice di Fiamme"},
  {id:870,name:"Falinks",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"B",type:"fighting",tag:"Att. Fisico",winRate:46.62,winRateChange:-0.16,moves:["Granfisico","Megacorno","Ferroriduttore","Picchiaduro","Sbarramento","Incornata"],uniteMove:"Cantamagliata"},
  {id:130,name:"Gyarados",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"water",tag:"Att. Fisico",winRate:52.95,winRateChange:0.28,moves:["Flagello","Splash","Dragospiro","Idrocoda","Cascata","Rimbalzo"],uniteMove:"Corrente Draconica"},
  {id:865,name:"Sirfetch'd",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"fighting",tag:"Att. Fisico",winRate:48.65,winRateChange:0.98,moves:["Beccata","Tagliofuria","Vorticefferato","Fogliama","Individua","Sferzata Meteorite"],uniteMove:"Fendente Cavalleresco"},
  {id:888,name:"Zacian",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"fairy",tag:"Att. Fisico",winRate:48.13,winRateChange:-1.19,moves:["Lacerazione","Attacco Rapido","Ferrartigli","Spadasanta","Agilità","Carineria"],uniteMove:"Spada del Re"},
  {id:925,name:"Pawmot",role:"Velocista",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"electric",tag:"Att. Fisico",winRate:50.43,winRateChange:0.23,moves:["Tuonoshock","Scintilla","Elettroshock","Zuffa","Fossa","Strofinamento"],uniteMove:"Rianimazione Pawmot"},
  {id:10034,name:"Mega Charizard X",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"dragon",tag:"Att. Fisico",winRate:49.95,winRateChange:0.14,moves:["Fiammata","Turbofuoco","Lanciafiamme","Fuocopugno","Fuocobomba","Fuococarica"],uniteMove:"Megaevoluzione"},
  {id:10067,name:"Mega Gyarados",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"water",tag:"Att. Fisico",winRate:57.23,winRateChange:0.9,moves:["Flagello","Splash","Dragospiro","Idrocoda","Cascata","Rimbalzo"],uniteMove:"Corrente Draconica"},
  {id:10071,name:"Mega Lucario",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"fighting",tag:"Att. Fisico",winRate:53.03,winRateChange:0.42,moves:["Attacco Rapido","Meteorpugno","Extrarapido","Crescipugno","Ossoraffiche","Zuffa"],uniteMove:"Ondasfera Letale"},
  {id:10043,name:"Mega Mewtwo X",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Esperto",tier:"S",type:"psychic",tag:"Att. Fisico",winRate:47.85,winRateChange:0.04,moves:["Sbigottimento","Graffio","Carineria","Ombrartigli","Furtivombra","Dolcetto o Scherzetto"],uniteMove:"Giochiamo Insieme?"},
  // Difensori aggiuntivi
  {id:781,name:"Dhelmise",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"B",type:"ghost",tag:"Att. Fisico",winRate:48.16,winRateChange:-1.51,moves:["Beccata","Ancorata","Vigorcolpo","Spettrotuffo","Giroballa","Pesobomba"],uniteMove:"Ancoraggio Gigavolt"},
  {id:395,name:"Empoleon",role:"Difensore",style:"Mischia",damage:"Fisico",difficulty:"Principiante",tier:"A",type:"water",tag:"Att. Fisico",winRate:48.82,winRateChange:-1.46},
  {id:706,name:"Goodra",role:"Difensore",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"dragon",tag:"Att. Speciale",winRate:46.45,winRateChange:-0.98,moves:["Bolla","Azione","Fangonda","Dragopulsar","Vigorcolpo","Scudacidolo"],uniteMove:"Rigenerapioggia"},
  {id:245,name:"Suicune",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"B",type:"water",tag:"Att. Speciale",winRate:47.85,winRateChange:-0.06,moves:["Bollabraggio","Ventogelo","Idropompa","Purogelo","Velaurora","Specchiovelo"],uniteMove:"Grazia del Vento del Nord"},
  {id:959,name:"Tinkaton",role:"Versatile",style:"Mischia",damage:"Fisico",difficulty:"Intermedio",tier:"A",type:"fairy",tag:"Att. Fisico",winRate:48.15,winRateChange:0.23,moves:["Sbigottimento","Martelfata","Martello Gigante","Strisciacolpo","Cannone Flash","Privazione"],uniteMove:"Capriccio di Tinkaton"},
  // Supporto aggiuntivi
  {id:869,name:"Alcremie",role:"Supporto",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"B",type:"fairy",tag:"Att. Speciale",winRate:49.38,winRateChange:-1.15,moves:["Profumino","Decorazione","Magibrillio","Nebbia","Scudacidolo","Aromaterapia"],uniteMove:"Pioggia di Panna"},
  {id:250,name:"Ho-Oh",role:"Difensore",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"fire",tag:"Att. Speciale",winRate:51.15,winRateChange:0.46,moves:["Appollaio","Raffica","Fuocobomba","Magifuoco","Aereattacco","Volo"],uniteMove:"Fiamma della Rinascita"},
  {id:380,name:"Latias",role:"Attaccante",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"A",type:"dragon",tag:"Att. Speciale",winRate:50.31,winRateChange:0.33,moves:["Foschisfera","Fascino","Zuccata Zen","Ripresa","Dragopulsar","Riflesso"],uniteMove:"Ali di Latias"},
  {id:54,name:"Psyduck",role:"Supporto",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"B",type:"water",tag:"Att. Speciale",winRate:52.03,winRateChange:-0.38,moves:["Pistolacqua","Confusione","Surf","Idropompa","Amnesia","Psichico"],uniteMove:"Panico da Emicrania"},
  {id:10196,name:"Rapidash",role:"Velocista",style:"Distanza",damage:"Sp.",difficulty:"Intermedio",tier:"B",type:"psychic",tag:"Att. Speciale",winRate:49.59,winRateChange:-0.35,moves:["Confusione","Vento di Fata","Psicotaglio","Forza Equina","Ondasana","Agilità"],uniteMove:"Carica Pastorale"},
  {id:134,name:"Vaporeon",role:"Supporto",style:"Distanza",damage:"Sp.",difficulty:"Principiante",tier:"A",type:"water",tag:"Att. Speciale",winRate:52.28,winRateChange:0.3,moves:["Pistolacqua","Altruismo","Fangonda","Idropompa","Scudacidolo","Acquaring"],uniteMove:"Vortice di Vaporeon"},
];
